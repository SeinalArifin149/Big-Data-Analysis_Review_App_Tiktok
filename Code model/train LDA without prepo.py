...
# 1. LOAD DATA
df = pd.read_csv('hasil_tokenisasi_final.csv')

# --- BAGIAN YANG HILANG (PREPROCESSING) ---
# Pastikan kolom teksmu dibaca string. 
# SUDAH DIEDIT: Nama kolom target adalah 'tokens'
nama_kolom_teks = 'tokens' 

# Tokenisasi sederhana (memecah kalimat jadi kata-kata)
# simple_preprocess juga berguna untuk membersihkan karakter aneh jika data 'tokens' masih kotor
